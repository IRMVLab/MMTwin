...
This file contains latent diffusion process following DiffuSeq: https://arxiv.org/abs/2210.08933
"""
...
class GaussianDiffusion:
    ...
    def training_losses_seq2seq(self, model, post_model, rl_x_start, t, rl_valid_mask, motion_feat_encoded, model_kwargs=None, noise=None):
        ...
        x_t_r = self.q_sample(x_start_r, t, noise=noise_r, mask=future_mask) # reparametrization trick.
